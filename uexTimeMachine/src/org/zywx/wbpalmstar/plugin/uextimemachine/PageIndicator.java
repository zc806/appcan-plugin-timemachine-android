...
public class PageIndicator extends LinearLayout {
	...
	public void setCurrentPage(int index) {
		for (int i = 0, size = getChildCount(); i < size; i++) {
			...
			if (i == index) {
				view.setBackgroundResource(EUExUtil.getResDrawableID("plugin_timemachine_page_focus"));
			} else {
				view.setBackgroundResource(EUExUtil.getResDrawableID("plugin_timemachine_page_normal"));
			}
		}
	}
